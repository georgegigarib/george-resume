export const en = {
  ...
  me: {
    presentation: {
      ...
      description:
        "I'm a curious software engineer who also plays guitar, not always at the same time though."
    },
    jokes: {
      joke1:
      ...
      joke4:
        "Some people make presentations to impress, I made mine to avoid talking... (didn't work anyway)."
    }
  },
  dev: {
    resume: {
